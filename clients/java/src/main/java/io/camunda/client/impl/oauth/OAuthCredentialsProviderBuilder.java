...
public final class OAuthCredentialsProviderBuilder {
  ...
  public OAuthCredentialsProviderBuilder clientAssertionKeystorePath(final String entraCertificatePath) {
    if (entraCertificatePath != null) {
      clientAssertionKeystorePath = Paths.get(entraCertificatePath);
    }
    return this;
  }
  ...
  public OAuthCredentialsProviderBuilder clientAssertionKeystorePassword(
    ...
    clientAssertionKeystorePassword = entraCertificatePassword;
    return this;
  }
  ...
  public boolean clientAssertionKeystoreConfigurationProvided() {
  ...
  public OAuthCredentialsProvider build() {
    ...
    applyDefaults();
    applyClientAssertionKeystoreConfiguration();

    validate();
    return new OAuthCredentialsProvider(this);
  }

  private void applyClientAssertionKeystoreConfiguration() {
    applyEnvironmentValueIfNotNull(this::clientAssertionKeystorePath, OAUTH_ENV_SSL_CLIENT_CERT_PATH);
    applyEnvironmentValueIfNotNull(this::clientAssertionKeystorePassword, OAUTH_ENV_SSL_CLIENT_CERT_PASSWORD);
  }
  ...
  private void validate() {
    try {
      ...
      if (clientAssertionKeystoreConfigurationProvided()) {
