...
import io.camunda.zeebe.protocol.impl.record.value.AsyncScopeMetadataRecord;
...
public final class TypedEventRegistry {
  ...
  static {
    ...
    registry.put(ValueType.ASYNC_REQUEST_METADATA, AsyncScopeMetadataRecord.class);
