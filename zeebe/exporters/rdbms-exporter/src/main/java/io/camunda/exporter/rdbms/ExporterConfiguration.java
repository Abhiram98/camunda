...
public class ExporterConfiguration {
  ...
  public void setCancelProcessInstanceHistoryTTL(final Duration batchOperationCancelProcessInstanceHistoryTTL) {
  ...
  public void setModifyProcessInstanceHistoryTTL(final Duration batchOperationModifyProcessInstanceHistoryTTL) {
  ...
  public void validate() {
    ...
    checkPositiveDuration(
        batchOperationCancelProcessInstanceHistoryTTL, "cancelProcessInstanceHistoryTTL", errors);
    checkPositiveDuration(
        batchOperationMigrateProcessInstanceHistoryTTL, "migrateProcessInstanceHistoryTTL", errors);
    checkPositiveDuration(
        batchOperationModifyProcessInstanceHistoryTTL, "modifyProcessInstanceHistoryTTL", errors);
    checkPositiveDuration(batchOperationResolveIncidentHistoryTTL, "resolveIncidentHistoryTTL", errors);
