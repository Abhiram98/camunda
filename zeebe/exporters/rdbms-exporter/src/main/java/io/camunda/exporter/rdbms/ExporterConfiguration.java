...
public class ExporterConfiguration {
  ...
  public RdbmsWriterConfig createRdbmsWriterConfig(final int partitionId) {
    return new RdbmsWriterConfig.Builder()
        ...
        .batchOperationCancelProcessInstanceHistoryTTL(cancelProcessInstanceHistoryTTL)
        .batchOperationMigrateProcessInstanceHistoryTTL(migrateProcessInstanceHistoryTTL)
        .batchOperationModifyProcessInstanceHistoryTTL(modifyProcessInstanceHistoryTTL)
        .batchOperationResolveIncidentHistoryTTL(resolveIncidentHistoryTTL)
