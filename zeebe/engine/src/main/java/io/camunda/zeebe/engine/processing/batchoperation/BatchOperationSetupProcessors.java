    ...
    typedRecordProcessors
        ...
        .onCommand(
            ...
            new BatchOperationFailProcessor(
                writers, commandDistributionBehavior, keyGenerator, partitionId, batchOperationMetrics))
        .onCommand(
            ValueType.BATCH_OPERATION_CHUNK,
            BatchOperationChunkIntent.CREATE,
            new BatchOperationCreateChunkProcessor(writers, batchOperationMetrics))
        .onCommand(
