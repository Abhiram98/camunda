...
public record RdbmsWriterConfig(
  ...
  public static class Builder implements ObjectBuilder<RdbmsWriterConfig> {
    ...
    private Duration batchOperationCancelProcessInstanceHistoryTTL = DEFAULT_BATCH_OPERATION_HISTORY_TTL;
    private Duration batchOperationMigrateProcessInstanceHistoryTTL = DEFAULT_BATCH_OPERATION_HISTORY_TTL;
    private Duration batchOperationModifyProcessInstanceHistoryTTL = DEFAULT_BATCH_OPERATION_HISTORY_TTL;
    ...
    public Builder batchOperationCancelProcessInstanceHistoryTTL(final Duration batchOperationCancelProcessInstanceHistoryTTL) {
      this.batchOperationCancelProcessInstanceHistoryTTL = batchOperationCancelProcessInstanceHistoryTTL;
      return this;
    }
    ...
    public Builder batchOperationModifyProcessInstanceHistoryTTL(final Duration batchOperationModifyProcessInstanceHistoryTTL) {
      this.batchOperationModifyProcessInstanceHistoryTTL = batchOperationModifyProcessInstanceHistoryTTL;
      return this;
    }

    public Builder batchOperationResolveIncidentHistoryTTL(final Duration batchOperationResolveIncidentHistoryTTL) {
